...
$stmt = $pdo->prepare("SELECT * FROM phrases");
$stmt->execute();
...
<body
  ...
  <div class="container mx-auto py-8">
    <div class="mx-auto flex max-w-5xl items-center justify-between px-6 py-8">
      ...
      <div>
        <a href="<?php echo isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '../../dashboard.php'; ?>"
                    ...
                    <div class="flex flex-col gap-1 my-1">
                      ...
                      <form method="POST"
                        ...
                        <button type="submit" name="delete_phrase" role="menuitem"
                          class="flex gap-2 px-1 items-center rounded-sm border border-transparent text-red-500 hover:bg-red-500/10 focus-visible:border-red-500/10 focus-visible:bg-red-500/10 focus-visible:text-red-500 focus-visible:outline-none">
